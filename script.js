...
// ── FILTROS SIDEBAR MÓVIL (solo en rutinas y ejercicios) ──
function abrirFiltros() {
  document.getElementById('filtros-sidebar')?.classList.add('open');
  document.getElementById('ejercicios-sidebar')?.classList.add('open');
...
function cerrarFiltros() {
  document.getElementById('filtros-sidebar')?.classList.remove('open');
  document.getElementById('ejercicios-sidebar')?.classList.remove('open');
